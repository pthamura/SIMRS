    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Daftar Pasien - Lunas</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                    ...
                    <table id="datatable" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">Rp. <?php echo rupiah($dataPasien->total);?>,-</td>
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a class="btn btn-primary btn-sm btn-flat" target="_blank" data-toggle="tooltip" data-placement="top" title="Print Bukti Pembayaran" href="<?php echo base_url('createpdf/pdfbayar/'.$dataPasien->id_pasien.'/'.$dataPasien->id_pendaftaran);?>"><small><i class="fa fa-print"></i> PRINT</small></a>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
