...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-medkit"></i> Poliklinik Obgyn
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('beranda'); ?>"><i class="fa fa-home"></i> Beranda</a></li>
            <li class="active">Poliklinik Obgyn</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Daftar Pasien Poliklinik Obgyn</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a class="btn btn-primary btn-sm btn-flat" data-toggle="tooltip" data-placement="top" title="Tindakan" href="<?php echo base_url('poliklinik/tindakan/obgyn/'.$dataPasien->id_pasien);?>"><small><i class="fa fa-pencil"></i> TINDAKAN</small></a>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
