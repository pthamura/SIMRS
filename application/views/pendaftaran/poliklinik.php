    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Pendaftaran Pasien Poliklinik</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php echo validation_errors(); ?>
                <?php echo form_open_multipart('pendaftaran/poliklinik', array('class' => 'form-horizontal')); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <input type="hidden" name="tujuan" value="Poliklinik">
