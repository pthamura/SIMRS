    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Pendaftaran Pasien Laboratorium</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php echo validation_errors(); ?>
                <?php echo form_open_multipart('pendaftaran/laboratorium', array('class' => 'form-horizontal')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <label for="id_poli">Laboratorium <small class="text-danger">*</small></label>
                            <select name="id_poli" class="form-control select2" style="width: 100% !important;" required>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <input type="hidden" name="tujuan" value="Laboratorium">
