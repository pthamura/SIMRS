...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>Laboratorium</li>
            <li class="active">Pemeriksaan Darah</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Daftar Pasien Lab Pemeriksaan Darah</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="btn-group">
                                        <a class="btn btn-primary btn-sm btn-flat" data-toggle="tooltip" data-placement="top" title="Input Hasil Pemeriksaan" href="<?php echo base_url('laboratorium/darah/inputdata/'.$dataPasien->id_pasien);?>"><small><i class="fa fa-pencil"></i> INPUT DATA </small></a>
                                    </div>
                                    <?php }else{ ?>
                                    <div class="btn-group">
                                        <a class="btn btn-primary btn-sm btn-flat" target="_blank" data-toggle="tooltip" data-placement="top" title="Print Hasil Pemeriksaan" href="<?php echo base_url('createpdf/pdfdarah/'.$dataPasien->id_pasien);?>"><small><i class="fa fa-print"></i> PRINT HASIL </small></a>
                                    </div>
                                    <?php } ?>
                                </td>
                            </tr>
